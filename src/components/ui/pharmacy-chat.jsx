                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        {message.type === 'image' && message.attachment?.url && (
                                                            <div className="mb-2">
                                                                <img
                                                                    src={`${import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL.replace("/api", "") : "http://localhost:8080"}${message.attachment.url}`}
                                                                    alt={message.attachment.filename}
                                                                    className="max-w-full max-h-64 rounded cursor-pointer"
                                                                    onClick={() => window.open(`${import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL.replace("/api", "") : "http://localhost:8080"}${message.attachment.url}`, '_blank')}
                                                                />
                                                            </div>
                                                        )}
                                                        ...
                                                        {message.type === 'file' && message.attachment?.url && (
                                                            <a
                                                                href={`${import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL.replace("/api", "") : "http://localhost:8080"}${message.attachment.url}`}
                                                        ...
                                                        {message.type === 'audio' && message.attachment?.url && (
                                                            <div className="flex items-center gap-2 min-w-[200px] mb-2">
                                                                <audio controls src={`${import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL.replace("/api", "") : "http://localhost:8080"}${message.attachment.url}`} className="h-8 w-full" />
                                                            </div>
                                                        )}
