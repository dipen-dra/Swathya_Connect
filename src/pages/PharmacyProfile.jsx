...
export default function PharmacyProfile() {
    ...
    const handleSubmitForReview = async () => {
        ...
        if (!formData.pharmacyLicenseNumber || !formData.panNumber) {
                                ...
                                <div className="space-y-6">
                                                ...
                                                <div className="flex items-start space-x-3">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <p className="text-sm text-yellow-800">
                                                            Upload your pharmacy license document and submit for admin review to start serving patients.
                                                        </p>
                                                    </div>
                                                </div>
                                            </CardContent>
                                        ...
                                        <Card className="border-2 border-green-200 bg-green-50">
                                            <CardContent className="p-4">
                                                <div className="flex items-start space-x-3">
                                                    ...
                                                    <div className="flex-1">
                                                        <h3 className="font-semibold text-green-900 mb-1">Profile Verified!</h3>
                                                        <p className="text-sm text-green-800">
                                                            Your pharmacy profile has been verified and approved. You can now accept orders from patients.
                                                        </p>
                                                        {profile?.verifiedAt && (
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => handleChange('pharmacyLicenseNumber', e.target.value)}
                                            ...
                                            <div className="flex items-center justify-between p-3 bg-green-50 border border-green-200 rounded-lg">
                                                ...
                                                {(!profile?.submittedForReview || profile?.verificationStatus === 'rejected') && (
                                                    <label className="cursor-pointer">
                                                        <span className="text-sm text-blue-600 hover:text-blue-700">Replace</span>
                                                        <input
                                                            type="file"
                                            ...
                                            <div className="space-y-2">
                                                <div className="flex items-center space-x-2">
                                                    <label className="flex-1">
                                                        <div className="flex items-center justify-center px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-400 cursor-pointer transition-colors">
                                                            <Upload className="h-5 w-5 text-gray-400 mr-2" />
                                                            <span className="text-sm text-gray-600">
                                                                {verificationDocPreview || 'Choose file to upload'}
                                                            </span>
                                                        </div>
                                                        <input
                                                            type="file"
                                    ...
                                    {(!profile?.submittedForReview || profile?.verificationStatus === 'rejected') && (
                                        <Button
                                            ...
                                            disabled={isSubmitting || !profile?.verificationDocument}
